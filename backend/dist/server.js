...
app.post("/api/incidents/trigger", asyncHandler(async (req, res) => {
...
app.get("/api/incidents", asyncHandler(async (_req, res) => {
    res.json(await repo.listIncidents());
}));
app.get("/api/incidents/:incidentId", asyncHandler(async (req, res) => {
...
app.patch("/api/incidents/:incidentId/status", asyncHandler(async (req, res) => {
...
app.post("/api/devices/heartbeat", asyncHandler(async (req, res) => {
...
async function publishIoT(eventName, task) {
    try {
        await task();
    }
    catch (error) {
